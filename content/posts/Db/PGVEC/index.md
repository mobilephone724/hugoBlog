...
date: 2023-10-25T07:40:58+08:00

publishDate: 2023-10-25T07:40:58+08:00
...
1. **Assignment step**: Assign each observation to the cluster with the nearest mean: ![](attachments/kmean_assign_step.png)
   
    where each $x_p$is assigned to exactly one $S^{t}$, even if it could be assigned to two or more of them.
2. **Update step**: Recalculate means ([centroids](https://en.wikipedia.org/wiki/Centroids "Centroids")) for observations assigned to each cluster.![](attachments/kmeans_update_step.png)
### kmeans 优化篇
...
#### page representation
![](attachments/IVF-pages-represent.png)
...
![](attachments/illustration-of-HNSW.png)
## 算法介绍
...
![](attachments/HNSW_INSERT_ALGORITH.png)
``` HnswInsertElement
/*
...
### search layer
![](attachments/HNSW_SEARCH_LAYER_ALGORITHM.png)
```
/*
...
### select neighbors
![](attachments/HNSW_SELECT_NEIGHBORS_ALGORITHMS.png)
...
![](attachments/HNSW_PAGE_REPRESENTATION.png)
![](attachments/PGVEC-HNSW-PAGE.png)
# vector database 调研

## qdrant

![image-20231007080940352](./attachments/image-20231007080940352.png)
...
![image-20231007081700863](./attachments/image-20231007081700863.png)
